...
loaded_lr_model = joblib.load('H:\Travel-Package-Price-Prediction-\decision_tree_reg_latest.joblib')
loaded_pca = joblib.load('H:\Travel-Package-Price-Prediction-\pca.joblib')
loaded_scaler = joblib.load('H:\Travel-Package-Price-Prediction-\scaler.joblib')
